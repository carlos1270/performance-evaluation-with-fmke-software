...
./docs/bin/ycsb logs cassandra-cql -P workloads/workloada -p hosts=$host -p port=$port -threads 100 -target 100000 -p recordcount=1000000000 -s > `expr "/logs/load_" + $cont + ".dat"`
